...
import aboutImg from '../assets/about-origin.jpg'; // 請更換為業主指定的照片

export default function AboutSection() {
  return (
    <section id="origin" className="relative py-24 overflow-hidden bg-white">
      {/* 背景裝飾大字 */}
      <div className="absolute top-10 right-0 text-[12rem] font-bold text-slate-50 select-none leading-none z-0">
        01. ABOUT US
      </div>
