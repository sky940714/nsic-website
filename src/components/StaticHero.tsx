...
export default function StaticHero() {
  return (
    <section className="py-24 bg-slate-900 text-white overflow-hidden relative min-h-[500px] flex items-center">
      {/* 1. 裝飾背景斜線 (增加層次感) */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-2">
               ...
               <p className="text-blue-400 text-lg md:text-xl font-medium">從台北出發，開啟與世界持續對話的起點</p>
            </div>
          ...
          <div className="space-y-10">
             ...
             <div className="flex justify-end">
               <Link 
                 to="/program" 
                 className="group relative flex items-center gap-4 bg-white text-slate-900 px-8 py-4 rounded-full font-bold overflow-hidden transition-all hover:pr-12 shadow-xl"
               >
