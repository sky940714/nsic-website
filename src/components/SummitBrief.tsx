...
export default function SummitBrief() {
  return (
    // 調整：手機版上下內距縮短 (pt-10 pb-12)，電腦版維持 py-24
    <section className="pt-10 pb-12 md:py-24 bg-[#f8fafc] text-[#1a1a1a] overflow-hidden relative border-y border-slate-100">
      {/* 背景裝飾線條 */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="space-y-8 md:space-y-12">
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              {/* 說明內容 */}
              {/* 調整：手機版段落間距縮短 (space-y-6) */}
              <div className="space-y-6 md:space-y-8 text-slate-600 leading-relaxed text-left md:text-justify text-lg">
